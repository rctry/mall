...
import com.rc.demo.common.utils.JwtTokenUtil;
import com.rc.demo.dao.UmsAdminRoleRelationDao;
import com.rc.demo.dto.AdminUserDetails;
import com.rc.demo.mbg.mapper.UmsAdminMapper;
import com.rc.demo.mbg.mapper.UmsPermissionMapper;
...
public class UmsAdminService implements IUmsAdminService {
    private static final Logger LOGGER = LoggerFactory.getLogger(IUmsAdminService.class);
    @Autowired
    ...
    public String login(String username, String password) {
        ...
        try {
            ...
            UserDetails userDetails = new AdminUserDetails(umsAdmin,getPermissionList(umsAdmin.getId()));;
